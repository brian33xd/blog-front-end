...
export const Inicio = () => {
  ...
  const getArticulo = async () => {
    const { datos } = await Request(global.url + 'articulo/657b6491188ddcc080c00855', "GET")
        ...
        <section className='inicio__destacado'>
          ...
          {Articulo ? (
            <article className='article__item'>
              ...
              <Link to={'/articulo/' + Articulo._id} className="article__more"> LEER MÁS <i className='bx bx-right-arrow-alt bx-fade-right' ></i></Link>
            </article>
